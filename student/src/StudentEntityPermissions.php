...
use Drupal\student\Entity\StudentEntityType;


/**
 * Provides dynamic permissions for Student entity of different types.
 *
 * @ingroup student
 *
 */
class StudentEntityPermissions{
   ...
   *
   * @return array
   *   The StudentEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (StudentEntityType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\student\Entity\StudentEntityType $type
   *   The StudentEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(StudentEntityType $type) {
    $type_id = $type->id();
