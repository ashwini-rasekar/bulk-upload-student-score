...
use Drupal\score\Entity\ScoreEntityType;


/**
 * Provides dynamic permissions for Score entity of different types.
 *
 * @ingroup score
 *
 */
class ScoreEntityPermissions{
   ...
   *
   * @return array
   *   The ScoreEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (ScoreEntityType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\score\Entity\ScoreEntityType $type
   *   The ScoreEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(ScoreEntityType $type) {
    $type_id = $type->id();
